...
bool saveCustomMiningCache(int epoch, CHAR16* directory = NULL)
{
    ...
    for (int i = 0; i < NUMBER_OF_TASK_PARTITIONS; i++)
    {
        ...
        success &=  gSystemCustomMiningSolutionCache[i].save(CUSTOM_MINING_CACHE_FILE_NAME, directory);
    }
    ...
    success &= gSystemCustomMiningSolutionV2Cache.save(CUSTOM_MINING_V2_CACHE_FILE_NAME, directory);
    return success;
}
